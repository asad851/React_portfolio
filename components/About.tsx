  ...
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
          ...
          {highlights.map((highlight, index) => (
            ...
            >
              <CardContent className="p-4 sm:p-6 text-center">
                <div className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-violet-500 to-indigo-500 rounded-lg mb-4 text-white group-hover:scale-110 transition-transform">
                  {highlight.icon}
                </div>
        ...
        <div className="mt-12 sm:mt-16 bg-gradient-to-r from-violet-50 to-indigo-50 dark:from-violet-900/10 dark:to-indigo-900/10 rounded-2xl p-6 sm:p-8">
