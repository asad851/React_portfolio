...
import { filezone, ecom } from "@/constants/images.ts";
const Projects = () => {
  const projects = [
    {
      ...
      <div className="container mx-auto">
        ...
        <div className="grid gap-8 lg:gap-12">
          {projects.map((project, index) => (
            <Card
              key={index}
              className={`group hover:shadow-2xl hover:shadow-blue-500/10 dark:hover:shadow-blue-500/20 transition-all duration-500 border-slate-200 dark:border-slate-700 overflow-hidden bg-white/50 dark:bg-slate-800/50 backdrop-blur-sm hover:bg-white/80 dark:hover:bg-slate-800/80 ${
            ...
            >
              <div className="lg:flex lg:items-center">
                ...
                <div className="lg:w-1/2 relative overflow-hidden">
                  <div className="aspect-video bg-gradient-to-br from-blue-100 via-purple-50 to-teal-100 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-teal-900/20 relative group-hover:scale-105 transition-transform duration-500 ">
                    <img
                    ...
                    <div className="flex items-center justify-center h-full">
                      <div className="text-center">
                        {/* <div className="inline-flex items-center justify-center w-16 h-16 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-xl mb-4 border border-slate-200 dark:border-slate-700">
                    ...
                    {/* Overlay with links */}
                    <div className="absolute inset-0 bg-gradient-to-br from-blue-900/80 via-purple-900/80 to-teal-900/80 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                      <Button
                        size="sm"
                ...
                <div className="lg:w-1/2 p-6 sm:p-8">
                  ...
                  <CardContent className="p-0 space-y-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {project.technologies.map((tech, idx) => (
                          <Badge
                            key={idx}
                            variant="outline"
                            className="text-xs bg-gradient-to-r from-blue-50 to-teal-50 dark:from-blue-900/20 dark:to-teal-900/20 border-blue-200 dark:border-blue-800 text-blue-700 dark:text-blue-300 hover:scale-105 transition-transform"
                          >
                            {tech}
                          </Badge>
                        ))}
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 pt-4">
                      <Button
                        className="bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 hover:from-blue-700 hover:via-purple-700 hover:to-teal-700 text-white shadow-lg hover:shadow-2xl transition-all flex-1 hover:scale-105 hover:-translate-y-1 relative overflow-hidden group"
                        onClick={() => window.open(project.liveUrl, "_blank")}
                      >
                      ...
                      <Button
                        variant="outline"
                        className="border-2 border-slate-300 dark:border-slate-600 hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-blue-400 dark:hover:border-blue-500 flex-1 hover:scale-105 hover:-translate-y-1 transition-all hover:shadow-lg"
                        onClick={() => window.open(project.githubUrl, "_blank")}
                      >
                        <Github className="h-4 w-4 mr-2" />
                        Source Code
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <Card className="bg-gradient-to-r from-blue-50 via-purple-50 to-teal-50 dark:from-blue-900/20 dark:via-purple-900/20 dark:to-teal-900/20 border-blue-200 dark:border-blue-800 hover:shadow-2xl hover:shadow-blue-500/10 transition-all duration-500">
            <CardContent className="p-6 sm:p-8">
              ...
              <Button
                size="lg"
                className="bg-gradient-to-r from-blue-600 via-purple-600 to-teal-600 hover:from-blue-700 hover:via-purple-700 hover:to-teal-700 text-white shadow-lg hover:shadow-2xl transition-all hover:scale-105 hover:-translate-y-1 relative overflow-hidden group"
                onClick={() => {
