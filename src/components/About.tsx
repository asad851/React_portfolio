  ...
  const highlights = [
    {
      ...
      description:
        "Building scalable applications with modern React patterns and best practices",
    },
    {
    ...
    },
    {
      ...
      description:
        "Implementing efficient solutions that improve load times and user satisfaction",
    },
    {
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto leading-relaxed">
            Innovative Frontend Developer with expertise in React.js, Next.js,
            and modern JavaScript frameworks, skilled in building scalable,
            responsive web applications. Proficient in developing reusable UI
            components, optimizing development workflows, and enhancing user
        ...
        <div className="mt-12 sm:mt-16 bg-gradient-to-r from-blue-50 to-teal-50 dark:from-blue-900/10 dark:to-teal-900/10 rounded-2xl p-6 sm:p-8">
          <div className="text-center">
            ...
            <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              I'm committed to writing clean, maintainable code and driving
              performance improvements through modern frontend architecture and
              design systems. My goal is to create exceptional digital
              experiences that make a real impact on users and businesses.
            </p>
          </div>
        </div>
      </div>
